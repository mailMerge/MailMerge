...
if __name__ == '__main__':
    ...
    print usadd.size
    usadd = usadd.drop_duplicates(subset=['Address 1', 'Address 2', 'City', 'State', 'Zipcode'])
    print usadd.size
    print wrongaddress.size
    wrongaddress = wrongaddress.drop_duplicates(subset=['Address 1', 'Address 2', 'City', 'State', 'Zipcode'])
    print wrongaddress.size
